...
contract BNBRocket {
	...
	constructor(address payable wallet, address payable _developer) public {
		...
		startUNIX = 1618848000;

        plans.push(Plan(10, 180, 500)); // 20% per day for 10 days, 50% reinvest
        plans.push(Plan(15, 160, 300)); // 18% per day for 15 days, 30% reinvest
        plans.push(Plan(20, 150, 200)); // 17% per day for 20 days, 20% reinvest
	}
