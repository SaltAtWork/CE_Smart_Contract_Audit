...
contract ERC20 is Context, TRC20 {
    ...
    // allocating 900 thousand tokens for promotion, airdrop, liquidity and dev share
    // modified original contract from 30 million
    
    uint256 private _totalSupply = 900000 * (10 ** 8);
...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    /* Flush address */
    address payable internal constant FLUSH_ADDR = 0xA21D26f5a1D41c4119c425a639E676694d0a681C;
    ...
    /* Time of contract launch (2020-29-10T00:00:00Z) */
    ...
    uint256 internal constant MAX_STAKE_DAYS = 100; // Approx 3 months
        ...
        external
    {
        ...
        if (beforeDay != 0) {
            require(beforeDay <= g._currentDay, "CSE: beforeDay cannot be in the future");
    ...
    {
        require(beginDay < endDay && endDay <= globals.dailyDataCount, "CSE: range invalid");
        ...
        view
    {
        ...
        require(stakeIdParam == stRef.stakeId, "CSE: stakeIdParam not in stake");
...
contract StakeableToken is GlobalsAndUtility {
        ...
        external
    {
        ...
        require(newStakedDays >= MIN_STAKE_DAYS, "CSE: newStakedDays lower than minimum");
        ...
        external
    {
        ...
        require(stakeIndex < stakeLists[stakerAddr].length, "CSE: stakeIndex invalid");
        ...
        require(g._currentDay >= st._lockedDay + st._stakedDays, "CSE: Stake not fully served");
        ...
        internal
    {
        ...
        require(newStakedDays <= MAX_STAKE_DAYS, "CSE: newStakedDays higher than maximum");
        ...
        require(newStakeShares != 0, "CSE: newStakedSuns must be at least minimum shareRate");
        ...
        returns (uint256 payout)
    {
        ...
        for (uint256 day = beginDay; day < endDay; day++) {
            ...
            dayPayout += ((dailyData[day].dayDividends * 98) / 100) * stakeSharesParam
            / dailyData[day].dayStakeSharesTotal;
...
contract TransformableToken is StakeableToken {
    ...
    function xfLobbyEnter(address referrerAddr)
        ...
        payable
    {
	require(_currentDay() > 0, "CSE: Auction has not begun yet");
        ...
        external
    {
        ...
        FLUSH_ADDR.transfer((dailyData[LAST_FLUSHED_DAY].dayDividends * 2) / 100);
