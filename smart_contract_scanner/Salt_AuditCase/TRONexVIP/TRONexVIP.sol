 ...
 *   - Personal hold-bonus: +0.2% for every 12 hours without withdraw. Maximal +15%.
 *   - Contract bonus: +0.05% for every 250 000 TRX on platform address balance. Maximal +15%.
 *   - VIP bonus: +0.1% for every deposited 5 000 TRX. Maximal +15%.
 *
 *   - Minimal deposit: 100 TRX, no maximal limit.
 *   - Total income: 200% (deposit included).
 *   - Earnings every moment, withdraw any time.
 *   - Deposits daily limits: NO LIMITS!
 *
 *   [AFFILIATE PROGRAM]
 *
 ...
 *   - Audition certificate: https://tronex.vip/files/audit_en.pdf
 *
 */
