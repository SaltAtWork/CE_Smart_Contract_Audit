...
contract BUSDGO {
	...
	constructor(address payable wallet, address payable _developer, address payable _marketing, IBEP20 _busd) public {
    ...
    function invest(address payable referrer,uint256 _days,uint8 plan, uint256 value) public payable {
        _invest(referrer, plan, msg.sender, value, _days);
